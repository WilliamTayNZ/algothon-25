...
nInst = 0   
nt = 0
commRate = 0.0005 # Commission of 5 basis points per dollar traded
dlrPosLimit = 10000 # Max $10k per stock
...
# Calculates Profit & Loss over the test period.
def calcPL(prcHist, numTestDays):
    # Initialize cash, position, total trading volume, and P&L tracker.
    cash = 0
